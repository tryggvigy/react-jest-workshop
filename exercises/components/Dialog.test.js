...
describe('Dialog', () => {
  ...
  it(`adds window click event listener on mount and removes on unmount.
      ...
      () => {
      // spyOn document.addEventListener, providing an empty function as a mock implementaion
      // spyOn document.removeEventListener, providing an empty function as a mock implementaion
